            ...
            <div class="navbar-header">
                <div class="navbar-brand col-xs-12">
                    ...
                    <ul class="header-actions">
                        <li>
                            <a class="openNewTab">View a Passage</a>
                        </li>
                        <li>
                            <a class="openNewTab">Find a Word</a>
                        </li>
                        <li>
                            <a class="openNewTab">Find a Subject</a>
                        </li>
                        <li>
                            <a class="openNewTab">Advanced Search</a>
                        </li>
                        <li>
                            <a class="toggleSidebar">Tools</a>
                        </li>
                    </ul>
