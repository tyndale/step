...
const C_Greek = 0; // TBRBMR
const C_enableVerbClr = 0; // TBRBMR
const C_inClrVerbItem = 1; // TBRBMR
const C_slctUlVerbItem = 2; // TBRBMR
const C_inPassiveBkgrdClr = 3; // TBRBMR
const C_inPassiveUlClr1 = 4; // TBRBMR
const C_chkbxPassiveBkgrdClr = 5; // TBRBMR
const C_chkbxPassiveBkgrdColrValue = 6; // TBRBMR
const C_chkbxPassiveUlClr1 = 7; // TBRBMR
const C_chkbxPassiveUlColr1Value = 8; // TBRBMR
const C_inMiddleBkgrdClr = 9; // TBRBMR
const C_inMiddleUlClr1 = 10; // TBRBMR
const C_chkbxMiddleBkgrdClr = 11; // TBRBMR
const C_chkbxMiddleBkgrdColrValue = 12; // TBRBMR
const C_chkbxMiddleUlClr1 = 13; // TBRBMR
const C_chkbxMiddleUlColr1Value = 14; // TBRBMR
const C_verbTableXHeader = 15; // TBRBMR
const C_verbTableYHeader = 16; // TBRBMR
const C_granularControlOfMoods = 17; // TBRBMR
const C_granularControlOfTenses = 18; // TBRBMR
const C_moodsOnOff = 19; // TBRBMR
const C_tensesOnOff = 20; // TBRBMR
const C_inAnimate = 21; // TBRBMR
const C_orderOfTense = 22; // TBRBMR
const C_orderOfMood = 23; // TBRBMR
const C_tenseToCombineWithPrevious = 24; // TBRBMR
const C_moodToCombineWithPrevious = 25; // TBRBMR
const C_xAxisForMood = 26; // TBRBMR
const C_inPassiveUlClr2 = 27; // TBRBMR
const C_inMiddleUlClr2 = 28; // TBRBMR
const C_chkbxPassiveUlClr2 = 29; // TBRBMR
const C_chkbxPassiveUlColr2Value = 30; // TBRBMR
const C_chkbxMiddleUlClr2 = 31; // TBRBMR
const C_chkbxMiddleUlColr2Value = 32; // TBRBMR
const C_OT = 1; // TBRBMR
const C_granularControlOfXAxis = 17; // TBRBMR
const C_granularControlOfYAxis = 18; // TBRBMR
const C_xAxisOnOff = 19; // TBRBMR
const C_yAxisOnOff = 20; // TBRBMR
const C_orderOfForm = 21; // TBRBMR
const C_verbFormToCombineWithPrevious = 22; // TBRBMR
const C_orderOfHebrewStem = 23; // TBRBMR
const C_hebrewStemToCombineWithPrevious = 24; // TBRBMR
const C_orderOfAramaicStem = 25; // TBRBMR
const C_aramaicStemToCombineWithPrevious = 26; // TBRBMR
const C_hebrewCodeOfStem = 27; // TBRBMR
const C_aramaicCodeOfStem = 28; // TBRBMR
const C_codeOfForm = 29; // TBRBMR
const C_xAxisForStem = 30; // TBRBMR
const C_enableAdvancedTools = 2; // TBRBMR
const C_enableGenderNumberClr = 3; // TBRBMR
const C_inClrMasculine = 4; // TBRBMR
const C_inClrFeminine = 5; // TBRBMR
const C_inClrNeuter = 6; // TBRBMR
const C_slctUlSingular = 7; // TBRBMR
const C_slctUlPlural = 8; // TBRBMR
const C_c4Version = 9; // TBRBMR
const C_activeIndexArray = 0; // TBRBMR
const C_middleIndexArray = 1; // TBRBMR
const C_passiveIndexArray = 2; // TBRBMR
const C_animationInterval = 3; // TBRBMR
const C_maxAnimationOnSamePageWithoutMovement = 4; // TBRBMR
const C_robinsonCodeOfTense = 5; // TBRBMR
const C_robinsonNameOfTense = 6; // TBRBMR
const C_defaultOrderOfTense = 7; // TBRBMR
const C_defaultTenseToCombineWithPrevious = 8; // TBRBMR
const C_robinsonCodeOfMood = 9; // TBRBMR
const C_robinsonNameOfMood = 10; // TBRBMR
const C_defaultOrderOfMood = 11; // TBRBMR
const C_defaultMoodToCombineWithPrevious = 12; // TBRBMR
const C_otNameOfVerbForm = 13; // TBRBMR
const C_defaultOrderOfOTVerbForm = 14; // TBRBMR
const C_defaultOTVerbFormToCombineWithPrevious = 15; // TBRBMR
const C_hebrewNameOfStem = 16; // TBRBMR
const C_defaultOrderOfHebrewStem = 17; // TBRBMR
const C_defaultHebriewStemToCombineWithPrevious = 18; // TBRBMR
const C_aramaicNameOfStem = 19; // TBRBMR
const C_defaultOrderOfAramaicStem = 20; // TBRBMR
const C_defaultAramaicStemToCombineWithPrevious = 21; // TBRBMR
const C_underlineCanvasName = 22; // TBRBMR
const C_canvasUnderlineName = 23; // TBRBMR
const C_moodIndexArray = 24; // TBRBMR
const C_tenseIndexArray = 25; // TBRBMR
const C_defaultCodeOfForm = 26; // TBRBMR
const C_defaultHebrewCodeOfStem = 27; // TBRBMR
const C_defaultAramaicCodeOfStem = 28; // TBRBMR
const C_colorCodeGrammarAvailableAndSelected = 0; // TBRBMR
const C_otMorph = 1; // TBRBMR
const C_displayQuickTryoutAccordion1 = 2; // TBRBMR
const C_displayQuickTryoutAccordion2 = 3; // TBRBMR
const C_displayQuickTryoutAccordion3 = 4; // TBRBMR
const C_uLBASEIMGS = 5; // TBRBMR
const C_ulVerbCSS = 6; // TBRBMR
const C_ulOTVbCSS = 7; // TBRBMR
const C_oTFormIndex2CSS = 8; // TBRBMR
const C_hebrewStemIndex2CSS = 9; // TBRBMR
const C_aramaicStemIndex2CSS = 10; // TBRBMR
const C_handleOfRequestedAnimation = 11; // TBRBMR
const C_copyOfPassiveIndexArray = 12; // TBRBMR
const C_copyOfMiddleIndexArray = 13; // TBRBMR
const C_animationIndexArray = 14; // TBRBMR
const C_timestampOfLastAnimation = 15; // TBRBMR
const C_numOfAnimationsAlreadyPerformedOnSamePage = 16; // TBRBMR
const C_axisUserSelectedToSort = 17; // TBRBMR
const C_userProvidedSortOrder = 18; // TBRBMR
const C_updatedGenderNumberCSS = 19; // TBRBMR
const C_userTurnGenderNumberFromOffToOn = 20; // TBRBMR
...
const cc = [ /* cc = Color code grammar const */
  // C_activeIndexArray
