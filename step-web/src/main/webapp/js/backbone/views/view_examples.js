		...
		'<div class="passageContainer examplesContainer">' +
			...
			'<div class="accordion-row" data-row="0">' +
				...
				'<div class="accordion-body">' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">NIV</span><span class="argSelect select-version">ESV</span><span class="argSelect select-version">KJV</span><span class="argSelect select-reference">John 3</span></span>' +
					'</a>' +
					'</span>' +
			...
			'<div class="accordion-row" data-row="1">' +
				...
				'<div class="accordion-body">' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">KJV</span><span class="argSelect select-reference">Col 3</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version" style="line-height:13px">KJV</span><span class="argSelect select-reference" style="line-height:13px">Col 1</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">KJV</span><span class="argSelect select-reference">Mat 1</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
					'<div class="explanationText"><%= __s.kjv_verb_number_and_gender_explanation %></div>' +
						...
						'<a href="javascript:cf.setNextPageURL(\'/?q=version=ESV|reference=1Jo.1&options=HVGUN\', \'function:openStats\', \'esv_word_frequency_explanation\')" title="<%= __s.click_to_try_this %>">' +
							...
							'<span class="argSelect select-other hidenarrow">' +
								'<span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-stats\' style="line-height:13px"></span>' +
		'					</span>' +
						'</a>' +
						'</span>' +
			...
			'<div class="accordion-row" data-row="2">' +
				...
				'<div class="accordion-body">' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">KJV</span><span class="argSelect select-reference">Eph 1</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">SBLG</span><span class="argSelect select-reference">Rom 12</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">THOT</span><span class="argSelect select-reference">Gen 1</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">CUn</span><span class="argSelect select-reference">Col 1</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
					...
					'<span class="form-control input-sm argSummary newArgSummary">' +
					'<span class="argSelect select-version">SBLG</span><span class="argSelect select-version">KJV</span><span class="argSelect select-version">CUN</span><span class="argSelect select-reference">Eph 5</span><span class="argSelect select-other hidenarrow"><span class=\'glyphicon glyphicon-cog\' style="line-height:13px">&nbsp;</span><span class=\'glyphicon glyphicon-plus\' style="line-height:13px">&nbsp;</span><span style="line-height:13px"><%= __s.display_grammarColor %></span></span></span>' +
					'</a>' +
					'</span>' +
